...
// const deWords = [...document.querySelectorAll('.mw-category-group ul li a')];
// const de = deWords.map(links => links.textContent).filter(a => a.includes('de'));
// console.log(de)


// 7. sort Exercise
// Sort the people alphabetically by last name
const alpha = people.sort((first, last) => last > first ? 1 : -1);
